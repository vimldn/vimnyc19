      ...
      <div className="relative min-h-screen flex items-center justify-center pt-16">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-black mb-2 leading-[1.1]">Building Health X</h1>

            <h2 className="text-3xl md:text-4xl font-black mt-2 mb-6 leading-[1.15]">
              Check a building{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-emerald-400">before</span>
